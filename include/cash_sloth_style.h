...
struct StyleSheet {
    ...
    struct Metrics {
        ...
        int minLeftColumnWidth = 260;
        int maxLeftColumnWidth = 400;
        int minProductsWidth = 640;
        int minRightColumnWidth = 420;
        int rightColumnWidth = 380;
        int minCartListWidth = 320;
        int minPaymentWidth = 260;
        int categoryHeight = 110;
        int categorySpacing = 22;
        int productTileHeight = 190;
        int tileGap = 24;
        int quickButtonHeight = 70;
        int quickColumns = 3;
        int actionButtonHeight = 88;
        int panelRadius = 32;
        int buttonRadius = 24;
        int titleHeight = 34;
        int titleGap = 16;
